...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void init() {
        ...
        if (users.isEmpty()) {
            ...
            admin.setTelephoneNumber("0359989702");
            admin.setStatus(true);
            admin.setAvt("https://firebasestorage.googleapis.com/v0/b/demoupload-d290c.appspot.com/o/img%2F1605973268631?alt=media&token=75372fd1-23c2-4fe8-968d-212abd8efc55");
